    ...
    return (
        <div className="xl:pt-[132px] pt-24 relative min-h-screen max-sm:pt-[65px]">
            ...
            <div className="container max-w-[1140px] mx-auto">
                ...
                <h2 className="text-custom-lg font-bold leading-[70px] max-w-[554px] max-sm:text-custom-5xl max-sm:leading-[52px] text-center mx-auto pt-[5px] uppercase sohne-schmal">
