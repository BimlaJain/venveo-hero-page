...
const Header = ({ myClass }) => {
    ...
    return (
        <div className='max-w-[1920px] mx-auto max-md:pt-6 max-sm:pt-4 flex max-md:items-center justify-between'>
            ...
            <div className={`flex items-center ${myClass} max-md:hidden -mt-8 `}>
            ...
            <div
                className={`md:hidden z-30 cursor-pointer pr-7`}
